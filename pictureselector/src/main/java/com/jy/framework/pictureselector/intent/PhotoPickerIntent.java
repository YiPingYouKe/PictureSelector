package com.jy.framework.pictureselector.intent;
...
import com.jy.framework.pictureselector.basic.PathModel;
import com.jy.framework.pictureselector.basic.SelectModel;
...
public class PhotoPickerIntent extends Intent{
    ...
    {
        this.putExtra(PhotoPickerActivity.EXTRA_SELECT_PATH,Integer.parseInt(model.toString()));
    }
    ...
    public void setSelectedPhotos(ArrayList<PhotoBean> imagePathis){
        this.putExtra(PhotoPickerActivity.EXTRA_DEFAULT_SELECTED_LIST, imagePathis);
    }
